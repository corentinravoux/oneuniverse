...
| S8 | **`SimDatabase` control plane**: discover/catalog/query stores, lineage DAG (parent→zoom child via `RegionSpec`), region-selection → `SimulationRequest` + lifecycle, parquet persistence, orchestration demo + lineage plot (metadata only, no runs — Rule 4) | planned — [`plans/2026-06-02-phaseS8-simdatabase-and-orchestration.md`](2026-06-02-phaseS8-simdatabase-and-orchestration.md) |
