...
| ~~S5~~ | **OUF-Sim write-path optimisation + product coverage** | **PAUSED** (resume when a real workload needs scale) — [`plans/2026-06-02-phaseS5-oufsim-optimisation-and-coverage.md`](2026-06-02-phaseS5-oufsim-optimisation-and-coverage.md) |
| ~~S6~~ | **OUF-Sim read-path optimisation** (benchmark + tests) | **PAUSED** — [`plans/2026-06-02-phaseS6-oufsim-read-optimisation.md`](2026-06-02-phaseS6-oufsim-read-optimisation.md) |
| ~~S7~~ | **AMR octree layout + input/IC products** | **PAUSED** — [`plans/2026-06-02-phaseS7-amr-and-input-products.md`](2026-06-02-phaseS7-amr-and-input-products.md) |
| **S8** | **Resimulation orchestration — the digital-twin core, the big stage** (sCOLA + zoom ICs + separate-universe tides). Six sub-phases: S8.0 research ✅, S8.1 fast-PM mini-sim (= 2nd `ForwardEngine`), S8.2 far-field φ(a), S8.3 IC extraction + **Gate 1**, S8.4 COLA-frame coupling + buffers, S8.5 merge + **Gate 2/3**, S8.6 `SimDatabase` control plane. **Skeleton starts after C5** (S8.1 PM first). Verdict: feasible as controlled approximation, not a full-sim replacement | **next big stage; S8.1 skeleton after C5** — [`plans/2026-06-02-phaseS8-resimulation-orchestration.md`](2026-06-02-phaseS8-resimulation-orchestration.md); research [`research/2026-06-02-resimulation-orchestration-feasibility.md`](../research/2026-06-02-resimulation-orchestration-feasibility.md) |
