...
| S6 | **OUF-Sim read-path optimisation** — ✅ T1 benchmark harness (`ReadBenchmark`/`measure_read`), T2 column projection (fewer bytes), T4 index LRU cache (no re-read), T5 threaded parallel reads. ⏳ remaining: T3 predicate pushdown, T6 Morton row order, T7 GPU-direct hook, T8 benchmark suite | **in progress (2026-06-02)** — [`plans/2026-06-02-phaseS6-oufsim-read-optimisation.md`](2026-06-02-phaseS6-oufsim-read-optimisation.md) |
