...
| S5 | **OUF-Sim optimisation + full product coverage** (driven by [`research/2026-06-02-oufsim-optimization-findings.md`](../research/2026-06-02-oufsim-optimization-findings.md)): bounded-memory streaming bucket-chunker, parallel/MPI partition writes, `ExecutionPlan` enforcement, wrap-don't-re-encode projection, + `tree`/`phase_space`/`gr_fields`/`checkpoints` dummy products, `SimDatasetView` streaming reads | planned — [`plans/2026-06-02-phaseS5-oufsim-optimisation-and-coverage.md`](2026-06-02-phaseS5-oufsim-optimisation-and-coverage.md) |
