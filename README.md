...
- [`cosmological_simulation_landscape.md`](research/cosmological_simulation_landscape.md) — Pillar 3 (digital twin) reference: simulation codes (Gadget/AREPO/RAMSES/HACC/ABACUS/ET/BORG/JaxPM/…), public suites (AbacusSummit/MTNG/TNG/FLAMINGO/Quijote/CAMELS/Flagship-2/CosmoDC2/SIBELIUS/MANTICORE/…), on-disk representations (particle, AMR, halo catalog, merger tree, lightcone, phase-space, GR 4-tensor, IC posterior chain, differentiable checkpoint), and the proposed **OUF-Sim manifest-of-manifests format**. Updated 2026-06-01.
